...
// ─── Unit tests for extract_iterable_element_type ───────────────────────────

#[test]
fn test_extract_iterable_element_type_list() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("list<User>"),
        Some("User".to_string()),
    );
}

#[test]
fn test_extract_iterable_element_type_array_generic() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("array<int, User>"),
        Some("User".to_string()),
    );
}

#[test]
fn test_extract_iterable_element_type_shorthand() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("User[]"),
        Some("User".to_string()),
    );
}

#[test]
fn test_extract_iterable_element_type_scalar() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("list<int>"),
        Some("int".to_string()),
    );
    assert_eq!(
        extract_iterable_element_type("int[]"),
        Some("int".to_string()),
    );
}

#[test]
fn test_extract_iterable_element_type_nullable() {
    use phpantom_lsp::docblock::extract_iterable_element_type;
...
#[test]
fn test_extract_iterable_element_type_fqn() {
    use phpantom_lsp::docblock::extract_iterable_element_type;
...
#[test]
fn test_extract_iterable_element_type_not_iterable() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(extract_iterable_element_type("string"), None);
    assert_eq!(extract_iterable_element_type("User"), None);
    assert_eq!(extract_iterable_element_type("Closure(): User"), None);
}

#[test]
fn test_extract_iterable_element_type_collection() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("Collection<int, User>"),
        Some("User".to_string()),
    );
}

#[test]
fn test_extract_iterable_element_type_iterable() {
    use phpantom_lsp::docblock::extract_iterable_element_type;

    assert_eq!(
        extract_iterable_element_type("iterable<User>"),
        Some("User".to_string()),
    );
}
