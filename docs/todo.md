...
|     | **[Bugs](todo/bugs.md)**                                                                                                                                                    |             |             |
| B180 | [Deprecation reported against a same-named variable from another method](todo/bugs.md#b180-a-deprecation-is-reported-against-a-same-named-variable-from-another-method)     | Low-Medium  | Medium      |
