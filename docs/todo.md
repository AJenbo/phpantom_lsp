...
| B28 | [A comment before the arrow hides a request field's receiver via the `safe()` hop](todo/bugs.md#b28-a-comment-before-the-arrow-hides-a-request-fields-receiver-via-the-safe-hop) | Low         | Low         |
