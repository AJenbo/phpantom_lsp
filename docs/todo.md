...
| B76  | [A member read off a class constant is looked for on the class that declares the constant](todo/bugs.md#b76-a-member-read-off-a-class-constant-is-looked-for-on-the-class-that-declares-the-constant) | Medium      | Medium      |
