...
| B2  | [A class declared in two files disappears when the winning file drops it](todo/bugs.md#b2-a-class-declared-in-two-files-disappears-when-the-winning-file-drops-it)          | Low-Medium  | Medium      |
