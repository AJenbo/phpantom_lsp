...
| B51 | [A chained static factory call loses its method-level template](todo/bugs.md#b51-a-chained-static-factory-call-loses-its-method-level-template)                             | Medium      | Medium      |
