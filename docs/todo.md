...
| B79 | [Find-references falls back to variable-name-vs-class-name text matching when a receiver's type can't be resolved](todo/bugs.md#b79-find-references-falls-back-to-variable-name-vs-class-name-text-matching-when-a-receivers-type-cant-be-resolved) | High        | Medium-High |
