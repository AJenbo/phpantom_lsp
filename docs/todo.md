...
| B27 | [A comment before the arrow hides a string-argument call's receiver](todo/bugs.md#b27-a-comment-before-the-arrow-hides-a-string-argument-calls-receiver)                       | Low         | Low-Medium  |
