...
| B98 | [Array-index access into a relation collection loses its element type across a multi-hop relation chain](todo/bugs.md#b98-array-index-access-into-a-relation-collection-loses-its-element-type-across-a-multi-hop-relation-chain) | Low-Medium  | Medium      |
...
| B95 | [A reversed-key array literal is accepted where a `list{...}` shape is required](todo/bugs.md#b95-a-reversed-key-array-literal-is-accepted-where-a-list-shape-is-required) | Low         | Medium      |
