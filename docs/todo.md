...
|     | **[Bugs](todo/bugs.md)**                                                                                                                                                    |             |             |
| B267 | [An array populated inside a closure via an `instanceof`-narrowed push isn't typed once the closure has run](todo/bugs.md#b267-an-array-populated-inside-a-closure-via-an-instanceof-narrowed-push-isnt-typed-once-the-closure-has-run) | Medium-High | High |
| B266 | [A variable-indexed array element doesn't inherit the array's value type even behind an `array_key_exists` guard](todo/bugs.md#b266-a-variable-indexed-array-element-doesnt-inherit-the-arrays-value-type-even-behind-an-array_key_exists-guard) | Medium-High | Medium-High |
| B268 | [`deprecated_usage` over-reports two call shapes PHPStan's own deprecation rule exempts](todo/bugs.md#b268-deprecated_usage-over-reports-two-call-shapes-phpstans-own-deprecation-rule-exempts) | Low-Medium | Low-Medium |
