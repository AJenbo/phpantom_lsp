...
| B26 | [`detect_string_call_context` still walks backwards past comments](todo/bugs.md#b26-detect_string_call_context-still-walks-backwards-past-comments)                          | Low         | Low-Medium  |
