...
| B269 | [An unqualified class name in an inline `@var` resolves to a same-named stub class instead of the current namespace](todo/bugs.md#b269-an-unqualified-class-name-in-an-inline-var-resolves-to-a-same-named-stub-class-instead-of-the-current-namespace) | Medium | Medium |
