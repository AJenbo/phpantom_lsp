...
| T39 | [No leniency modelling for builtin functions whose failure branch is conventionally never checked](todo/type-inference.md#t39-no-leniency-modelling-for-builtin-functions-whose-failure-branch-is-conventionally-never-checked) (`tempnam`, `fopen`, …) | Medium-High | Medium      |
