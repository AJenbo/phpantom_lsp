...
| B22 | [A union of two classes sharing a short name collapses to the first](todo/bugs.md#b22-a-union-of-two-classes-sharing-a-short-name-collapses-to-the-first)                    | Medium      | Medium      |
